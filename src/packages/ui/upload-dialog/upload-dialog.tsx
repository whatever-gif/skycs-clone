...
export const isBreakAtom = atom<Boolean>(false);
                ...
                <div className="">
                  <div className="flex justify-between align-start">
                    <div className="flex w-[90%] ">
                      ...
                      />
                      <p
                        className={"truncate w-[380px] flex align-items-center"}
                      >
                        {f.name}
                      </p>
                    </div>
                    <button
                      className="ml-2 mr-1 w-[10%]"
                      onClick={() => {
                  ...
                  <ProgressBar
                    ...
                    className="mx-1"
                    width={"95%"}
                    defaultValue={progressValue as number}
