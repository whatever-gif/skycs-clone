...
import { useSavedStateCondition } from "../base-gridview/components/use-saved-state-condition";
...
export const SearchPanelCondition = ({
  conditionFields = [],
  data,
  onSearch,
  storeKey,
  ...
  const { loadState, saveState } = useSavedStateCondition<ColumnOptions[]>({
