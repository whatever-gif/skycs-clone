...
import { districtContactAtom } from "./DistrictContactField";
import { provinceContactAtom } from "./ProvinceContactField";

const WardContactField = ({ param, customOptions, field }: any) => {
  ...
  const districtContract = useAtomValue(districtContactAtom);
  const provinceContract = useAtomValue(provinceContactAtom);

  const { data }: any = useQuery(
    ["MstWardContact", provinceContract, districtContract],
    async () => {
...
export default WardContactField;
