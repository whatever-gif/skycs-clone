...
import { districtInvoiceAtom } from "./DistrictInvoiceField";
import { provinceInvoiceAtom } from "./ProvinceInvoiceField";

const WardInvoiceField = ({ param, customOptions, field }: any) => {
  ...
  const districtContract = useAtomValue(districtInvoiceAtom);
  const provinceContract = useAtomValue(provinceInvoiceAtom);

  const { data }: any = useQuery(
    ["MstWardInvoice", provinceContract, districtContract],
    async () => {
...
export default WardInvoiceField;
