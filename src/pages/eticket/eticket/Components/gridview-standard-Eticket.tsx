...
import "@packages/ui/base-gridview/base-gridview.scss";
...
import PageStandardSizeComponent, {
  Config,
} from "../../../../packages/ui/base-gridview/components/PageStandardSize";
import { PopupGridStandardPageNavigator } from "../../../../packages/ui/base-gridview/components/popup-grid-page-navigator-standard";
import { PopupGridStandardPageSummary } from "../../../../packages/ui/base-gridview/components/popup-grid-page-summary-standard";
import {
...
import {
  ColumnOptions,
  ToolbarItemProps,
} from "../../../../packages/ui/base-gridview/types";
              ...
              if (translateFilter.includes(obj.dataField)) {
                return (
                  <Column
                    ...
                    cellRender={(data) => {
                      return <span>{t(`${obj.dataField}`)}</span>;
                    }}
                  />
                );
              }
...
export const GridViewStandardEticket = forwardRef(
...
GridViewStandardEticket.displayName = "GridViewStandardEticket";
