        ...
        <ContentSearchPanelLayout>
          <ContentSearchPanelLayout.Slot name={"SearchPanel"}>
            <SearchPanelV2
              ...
              permission="MNU_RPT_CPNCAMPAIGN_RESULT_CALL_SEARCH"
            />
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <GridViewCustomize
              ...
              isLoading={isLoading}
              dataSource={
                data?.Data?.Rpt_Cpn_CampaignResultCall?.map((item: any) => {
                  if (
                    item.CampaignStatus !== "FINISH" &&
                    item.CampaignStatus !== "PENDING" &&
                    item.CampaignStatus !== "APPROVE" &&
                    item.CampaignStatus !== "PAUSED"
                  ) {
                    item.CampaignStatus = "CONTINUED";
                  }
                  return item;
                }) ?? []
              }
              ...
              toolbarItems={[
                {
                  ...
                  visible: checkPermision(
                    "MNU_RPT_CPNCAMPAIGN_RESULT_CALL_SEARCH"
                  ),
                },
                {
                  location: "before",
                  ...
                  options: {
                    ...
                    visible: checkPermision(
                      "MNU_RPT_CPNCAMPAIGN_RESULT_CALL_EXCEL"
                    ),
                  },
                },
              ]}
