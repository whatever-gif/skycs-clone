...
import "../CustomerEditPage/components/style.scss";
import { GroupFieldDemo } from "./GroupFieldDemo";
  ...
  useEffect(() => {
    Promise.all([
      ...
      if (param?.CustomerCodeSys) {
        ...
        setValue("CustomerCode", res[3].data);
        setValue("CustomerCodeInvoice", res[3].data);
      }
    });
  }, [param?.CustomerCodeSys]);
      ...
      <AdminContentLayout className={"province-management"}>
        <AdminContentLayout.Slot name={"Header"}>
          <div className="header flex justify-between items-center w-full px-2 py-2">
            ...
            <div className="flex gap-2">
              {param?.type == "edit" ? (
                <PermissionContainer
                  permission={"BTN_CUSTOMER_EDITCUSTOM_SAVE"}
                >
                  <Button
        ...
        <AdminContentLayout.Slot name={"Content"}>
          ...
          {!(isLoadingCodeField || isLoadingGroupCode || isLoadingDynamic) && (
            <form
              ref={ref}
              className="overflow-auto px-4 flex-col gap-2"
              onSubmit={handleSubmitDemo(onSubmit)}
            >
...
export default CustomerEditPageDemo;
