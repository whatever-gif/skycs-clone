...
export const HeaderPart = ({
  ...
  return (
    <HeaderNewForm
      permissionCreate={"BTN_ADMIN_USERMANANGER_CREATE"}
      permissionExportExecl={"BTN_ADMIN_USERMANANGER_EXPORT"}
      permissionImportExecl={""}
      permissionSearch={"BTN_ADMIN_USERMANANGER_SEARCH"}
      permissionMore={"BTN_ADMIN_USERMANANGER_EXPORT"}
      hidenMore={true}
