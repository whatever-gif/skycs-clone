...
const RptCallAnalysisByTalkTime = () => {
  ...
  const { data: getData, isLoading }: any = useQuery(
    ["getTalkTime", currentValue, currentCode],
    async () => {
      ...
      const resp: any = await api.RptCallAnalysis_RptCallAnalysisByTalkTime({
  ...
  const tableDetail = useMemo(() => {
    return (
      <GridViewPopup
        ...
        storeKey={"RptCallAnalysisByTalkTime-search"}
        editable={false}
        checkboxMode="none"
        height={500}
        toolbarItems={[
  ...
  const handleSave = async () => {
    ...
    const Rpt_CallAnalysis = {
      ...
      RptCallAnalysisType: "RPTCALLANALYSISBYTALKTIME",
  ...
  return (
    <AdminContentLayout
      className={"RptCallAnalysisByTalkTime h-full w-full rpt-container"}
    >
      <AdminContentLayout.Slot name={"Header"}>
        <div className="header flex justify-between items-center w-full px-2">
          <div className="font-semibold">{t("RptCallAnalysisByTalkTime")}</div>
          <div className="flex">
            <PermissionContainer
              permission={"BTN_RPT_PHAN_TICH_THOI_GIAN_DAM_THOAI_EXPORT_EXCEL"}
            >
              <Button
                style={{
                  padding: 10,
            ...
            <PermissionContainer
              permission={"BTN_RPT_PHAN_TICH_THOI_GIAN_DAM_THOAI_LUU_RPT"}
            >
              <Button
                style={{
                  padding: 10,
      ...
      <AdminContentLayout.Slot name={"Content"}>
        <ContentSearchPanelLayout searchPermissionCode="">
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <div className="w-full h-full d-flex-col pb-2">
              ...
              {!currentValue.DataSource || !currentCode.SvImprvCodeSys ? (
                ...
                <>
                  ...
                  <GridViewCustomize
                    nameFile={
                      t("Phân tích thời gian đàm thoại") +
            ...
            <Popup
              visible={openDetail}
              title={`${t("RptCallAnalysisByTalkTime Detail")}`}
              showCloseButton
              hideOnOutsideClick
...
export default RptCallAnalysisByTalkTime;
