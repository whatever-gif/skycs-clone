...
export const HeaderPart = ({
  ...
  return (
    <HeaderNewForm
      permissionCreate={"BTN_ADMIN_USERMANAGER_CREATE"}
      permissionExportExecl={"BTN_ADMIN_USERMANAGER_EXPORTEXCEL"}
      permissionImportExecl={""}
      permissionSearch={"BTN_ADMIN_USERMANAGER_SEARCH"}
      permissionMore={"BTN_ADMIN_USERMANAGER_EXPORTEXCEL"}
      hidenMore={true}
